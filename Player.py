...
class Player(object):
    def __init__(self):
        ...
        self.anim_image_right = Helper.loadImage("res/tileset.png", (255, 0, 255))
        self.anim_right = Animation.Animation(self.anim_image_right, 32, 32, 2, 32, 64, 10)
        ...
        self.anim_left = Animation.Animation(self.anim_image_left, 32, 32, 2, 32, 64, 10)
